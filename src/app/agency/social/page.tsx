  ...
  return (
    <div className="space-y-6 flex flex-col h-[calc(100vh-6rem)]">
      <div className="flex flex-wrap justify-between items-center gap-4">
        <PageHeader 
          title="Social Media" 
          description="Gestão de demandas e cronograma de publicações de todos os clientes."
        />
      ...
      <div className="flex-1 overflow-x-auto pb-4">
        <KanbanBoard clientIdFilter={clientIdFilter} moduleFilter="social" key={refreshKey} />
      </div>
